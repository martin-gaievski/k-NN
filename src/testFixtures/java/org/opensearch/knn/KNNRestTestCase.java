...
public class KNNRestTestCase extends ODFERestTestCase {
    ...
    public Response trainModel(
        ...
        return trainModel(modelId, trainingIndexName, trainingFieldName, dimension, method, description, OpenSearchRestTestCase::adminClient);
    }
    ...
    protected Settings.Builder noStrictDeprecationModeRestClientSettingsBuilder() {
